...
import { Skeleton } from '@/components/ui/skeleton'; // Assuming the standard import for Shadcn Skeleton
...
export default function LoadingSummary() {
  return (
    <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to-white">
      {/* Assuming BgGradient is a custom component imported elsewhere */}
