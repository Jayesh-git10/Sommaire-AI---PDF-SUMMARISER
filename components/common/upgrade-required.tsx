...
export default function UpgradeRequired() {
    return (
        <div className="relative min-h-screen flex justify-center pt-24">
            <BgGradient className="form-rose-100 via-rose-50 to-white" />
            <div className="container px-8 py-16">
                <div className="flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto">
                    ...
                    <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Subscription Required</h1>
